...
$this->registerCssFile('@web/static/css/2.chunk.css');
$this->registerCssFile('@web/static/css/main.chunk.css');
?>
...
<script>!function (e) {
        function t(t) {
            for (var n, u, i = t[0], c = t[1], l = t[2], p = 0, s = []; p < i.length; p++) u = i[p], Object.prototype.hasOwnProperty.call(o, u) && o[u] && s.push(o[u][0]), o[u] = 0;
        ...
        u.e = function (e) {
            ...
            if (0 !== r) if (r) t.push(r[2]); else {
                ...
                i.charset = "utf-8", i.timeout = 120, u.nc && i.setAttribute("nonce", u.nc), i.src = function (e) {
                    return u.p + "static/js/" + ({}[e] || e) + ".chunk.js"
                }(e);
                var c = new Error;
                a = function (t) {
        ...
        var i = this["webpackJsonpeapteka-hack-timetable"] = this["webpackJsonpeapteka-hack-timetable"] || [],
            c = i.push.bind(i);
        i.push = t, i = i.slice();
